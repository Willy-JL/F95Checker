...
cmd.exe /c rmdir /s /q dist\windows\F95Checker\Include
cmd.exe /c del /f /q dist\windows\F95Checker\api-ms-win-*
cmd.exe /c del /f /q dist\windows\F95Checker\Qt5WebSockets.dll
cmd.exe /c del /f /q dist\windows\F95Checker\Qt5Svg.dll
cmd.exe /c del /f /q dist\windows\F95Checker\Qt5Quick.dll
cmd.exe /c del /f /q dist\windows\F95Checker\Qt5QmlModels.dll
cmd.exe /c del /f /q dist\windows\F95Checker\Qt5Qml.dll
cmd.exe /c del /f /q dist\windows\F95Checker\Qt5Network.dll
cmd.exe /c del /f /q dist\windows\F95Checker\Qt5DBus.dll
cmd.exe /c del /f /q dist\windows\F95Checker\ucrtbase.dll
...
cmd.exe /c move /y dist\windows\F95Checker\python3.dll dist\windows\F95Checker\lib
cmd.exe /c move /y dist\windows\F95Checker\pywintypes38.dll dist\windows\F95Checker\lib
...
cmd.exe /c move /y dist\windows\F95Checker\win32wnet.pyd dist\windows\F95Checker\lib
...
cd dist\windows\F95Checker
start F95Checker.exe