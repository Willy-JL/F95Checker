...
async def connect():
    ...
    await create_table(
        ...
        columns={
            ...
            "ext_highlight_tags":          f'INTEGER DEFAULT {int(False)}',
            ...
            "highlight_tags":              f'INTEGER DEFAULT {int(False)}',
            ...
            "tags_positive":               f'TEXT    DEFAULT "[]"',
            "tags_negative":               f'TEXT    DEFAULT "[]"',
            "tags_critical":               f'TEXT    DEFAULT "[]"',
