...
async def init_config():
    ...
    if True:
        ...
        globals.config["options"].setdefault("refresh_completed_games",      True  )
        globals.config["options"].setdefault("keep_image_on_game_update",    False )
        globals.config["options"].setdefault("keep_exe_path_on_game_update", False )
